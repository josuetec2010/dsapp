...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("dsDSDB"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class dsDSDB
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As dsDSDB = CType(MyBase.Clone,dsDSDB)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsDSDB"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsDSDB.xsd"
    ...
    Partial Public Class clientesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddclientesRow(ByVal nombre As String, ByVal apellido As String, ByVal fecha_registro As Date) As clientesRow
            Dim rowclientesRow As clientesRow = CType(Me.NewRow,clientesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, nombre, apellido, fecha_registro}
...
Namespace dsDSDBTableAdapters
    ...
    Partial Public Class clientesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[clientes] WHERE (([id] = @Original_id) AND ([nombre] = @Origin"& _ 
                "al_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_fecha_registro = "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[clientes] ([nombre], [apellido], [fecha_registro]) VALUES (@no"& _ 
                "mbre, @apellido, @fecha_registro);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, nombre, apellido, fecha_registro "& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[clientes] SET [nombre] = @nombre, [apellido] = @apellido, [fecha_re"& _ 
                "gistro] = @fecha_registro WHERE (([id] = @Original_id) AND ([nombre] = @Original"& _ 
                "_nombre) AND ([apellido] = @Original_apellido) AND ((@IsNull_fecha_registro = 1 "& _ 
                "AND [fecha_registro] IS NULL) OR ([fecha_registro] = @Original_fecha_registro)))"& _ 
                ";"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, nombre, apellido, fecha_registro FROM clientes WHERE (id = @id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.dsapp.My.MySettings.Default.dsdbConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, nombre, apellido, fecha_registro FROM dbo.clientes"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As dsDSDB.clientesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As dsDSDB.clientesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dsDSDB.clientesDataTable = New dsDSDB.clientesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dsDSDB.clientesDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As dsDSDB) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_fecha_registro As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal nombre As String, ByVal apellido As String, ByVal fecha_registro As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal apellido As String, ByVal fecha_registro As Global.System.Nullable(Of Date), ByVal Original_id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_fecha_registro As Global.System.Nullable(Of Date), ByVal id As Integer) As Integer
            If (nombre Is Nothing) Then
                Throw New Global.System.ArgumentNullException("nombre")
            Else
            ...
            If (Original_fecha_registro.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_fecha_registro.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal nombre As String, ByVal apellido As String, ByVal fecha_registro As Global.System.Nullable(Of Date), ByVal Original_id As Integer, ByVal Original_nombre As String, ByVal Original_apellido As String, ByVal Original_fecha_registro As Global.System.Nullable(Of Date)) As Integer
            Return Me.Update(nombre, apellido, fecha_registro, Original_id, Original_nombre, Original_apellido, Original_fecha_registro, Original_id)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As dsDSDB, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As dsDSDB, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._clientesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As dsDSDB, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._clientesTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As dsDSDB) As Integer
